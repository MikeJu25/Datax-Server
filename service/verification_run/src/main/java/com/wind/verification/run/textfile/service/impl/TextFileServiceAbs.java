...
public abstract class TextFileServiceAbs {
    ...
    public JSONObject textFileProcessor(TextFileHandler textFileHandler, boolean isReading) {
        ...
        boolean compressProvided = DatabaseUtil.isStringExist(textFileHandler.getCompress());
        boolean encodingProvided = DatabaseUtil.isStringExist(textFileHandler.getEncoding());
        boolean nullFormatProvided = DatabaseUtil.isStringExist(textFileHandler.getNullFormat());
